...
The assumptions for a simple linear regression are that observations are independent from one another, and residuals are normally distributed with constant variance. These assumptions differ from the assumptions for t-tests and ANOVA only because it specifies that we are looking at the residuals. 
